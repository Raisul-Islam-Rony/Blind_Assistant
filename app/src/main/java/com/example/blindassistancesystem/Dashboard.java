...
public class Dashboard extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       ActivityCompat.requestPermissions(Dashboard.this, new String[]{Manifest.permission.CALL_PHONE},100);
        ...
        object_button=(Button)findViewById(R.id.objectbutton);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data !=null){
            ...
            startActivity(phone_intent);
                 ...
                 else if (arrayList.get(0).toString().equals("police line")){
                     String phone_number="01848-391188";
                 Intent phone_intent = new Intent(Intent.ACTION_CALL);
            ...
            startActivity(phone_intent);
                    ...
                    else if (arrayList.get(0).toString().equals("call police line")){
                     String phone_number="01848-391188";
                 Intent phone_intent = new Intent(Intent.ACTION_CALL);
            ...
            startActivity(phone_intent);
                             ...
                             else if (arrayList.get(0).toString().equals("call emergency helpline")){
                     String phone_number="999";
                 Intent phone_intent = new Intent(Intent.ACTION_CALL);
            ...
            startActivity(phone_intent);
                             ...
                             else if (arrayList.get(0).toString().equals("emergency helpline")){
                     String phone_number="999";
                 Intent phone_intent = new Intent(Intent.ACTION_CALL);
